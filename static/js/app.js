	...
	*/
	...
	navigator.mediaDevices.getUserMedia(constraints).then(function(stream) {
		...
		*/
		...
		//update the format
		document.getElementById("formats").innerHTML=" "+encodingTypeSelect.options[encodingTypeSelect.selectedIndex].value+" @ "+audioContext.sampleRate/1000+"kHz"
